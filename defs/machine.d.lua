...
---OpenComputers machine.lua v1.0 by Perodactyl.
...
---  @field pushSignal  fun(name:string,...)
...
---  @field beep        fun(frequency?: number|string, duration?: number)
...
---  @field type    fun(address: ID): componentType Get the component type of the component with the specified address.
---  @field slot    fun(address: ID): integer Return slot number which the component is installed into. Returns -1 if it doesn't otherwise make sense.
---  @field fields  fun(address: ID): string Undocumented
---  @field get     fun(address: string, componentType?: componentType): ID | nil, string Tries to resolve an abbreviated address to a full address. Returns the full address on success, or `nil` and an error message otherwise. Optionally filters by component type.
